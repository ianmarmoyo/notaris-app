...
{
  const PATH_IMAGE = "balik_nama_sertifikat/image/";
  function __construct()
  {
    ...
    view()->composer('content.balik_nama_sertifikat.*', function ($view) {
      $view->with('page_title', 'Balik Nama Sertifikat');
    });
  }
  ...
  public function store(Request $request)
  {
    ...
    $update = BalikNamaSertifikat::find($balik_nama_waris_id);
    $update->update([
  ...
  public function form($work_order_assignment_id)
  {
    ...
    $procedures = BalikNamaSertifikat::with('work_order_assignment')->where('work_order_assignment_id', $work_order_assignment_id)->get();
    ...
    // dd($wo_attachment);
    return view('content.balik_nama_sertifikat.form', compact(
      'title',
      'procedures',
  ...
  public function detail($work_order_assignment_id)
  {
    ...
    return view('content.balik_nama_sertifikat.detail', compact(
      'title',
      'procedures',
      'work_order_assignment_id',
      'wo_attachment',
