...
class PendirianKoperasiController extends Controller
{
  const PATH_IMAGE = "pendirian_koperasi/image/";
  function __construct()
  {
    ...
    view()->composer('content.pendirian_koperasi.*', function ($view) {
      $view->with('page_title', ucwords('Pendirian Koperasi'));
    });
  }
  ...
  public function store(Request $request)
  {
    ...
    $update = PendirianKoperasi::find($balik_nama_waris_id);
    $update->update([
  ...
  public function form($work_order_assignment_id)
  {
    ...
    $procedures = PendirianKoperasi::with('work_order_assignment')->where('work_order_assignment_id', $work_order_assignment_id)->get();
    ...
    // dd($wo_attachment);
    return view('content.pendirian_koperasi.form', compact(
      'title',
      'procedures',
  ...
  public function detail($work_order_assignment_id)
  {
    ...
    return view('content.pendirian_koperasi.detail', compact(
      'title',
      'procedures',
      'work_order_assignment_id',
      'wo_attachment',
