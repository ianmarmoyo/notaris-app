...
class WarmarkingController extends Controller
{
  const PATH_IMAGE = "balik_nama_hibah/image/";
  function __construct()
  {
    ...
    view()->composer('content.warmarking.*', function ($view) {
      $view->with('page_title', ucwords('Warmarking'));
    });
  }
  ...
  public function store(Request $request)
  {
    ...
    $update = Warmarking::find($balik_nama_waris_id);
    $update->update([
  ...
  public function form($work_order_assignment_id)
  {
    ...
    $procedures = Warmarking::with('work_order_assignment')->where('work_order_assignment_id', $work_order_assignment_id)->get();
    ...
    // dd($wo_attachment);
    return view('content.warmarking.form', compact(
      'title',
      'procedures',
  ...
  public function detail($work_order_assignment_id)
  {
    ...
    return view('content.warmarking.detail', compact(
      'title',
      'procedures',
      'work_order_assignment_id',
      'wo_attachment',
