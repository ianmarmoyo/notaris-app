...
class PenggabunganSertifikatController extends Controller
{
  const PATH_IMAGE = "penggabungan_sertifikat/image/";
  ...
  function __construct()
  {
    ...
    view()->composer('content.penggabungan_sertifikat.*', function ($view) {
      $title = "Penugasan Penggabungan Sertifikat";
      $view->with('page_title', 'Penggabungan Sertifikat";');
  ...
  public function store(Request $request)
  {
    ...
    $update = PenggabunganSertifikat::find($balik_nama_waris_id);
    $update->update([
  ...
  {
    $procedures = PenggabunganSertifikat::with('work_order_assignment')->where('work_order_assignment_id', $work_order_assignment_id)->get();
    ...
    // dd($wo_attachment);
    return view('content.penggabungan_sertifikat.form', compact(
      'procedures',
  ...
  public function detail($work_order_assignment_id)
  {
    ...
    return view('content.penggabungan_sertifikat.detail', compact(
      'procedures',
      'work_order_assignment_id',
      'wo_attachment',
