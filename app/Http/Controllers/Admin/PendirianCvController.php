...
{
  const PATH_IMAGE = "pendirian-cv/image/";
  ...
  function __construct()
  {
    ...
    view()->composer('content.pendirian_cv.*', function ($view) {
      $title = "Penugasan Pendirian CV";
      $view->with('page_title', 'Pendirian CV');
  ...
  public function store(Request $request)
  {
    ...
    $update = PendirianCV::find($balik_nama_waris_id);
    $update->update([
  ...
  public function detail($work_order_assignment_id)
  {
    ...
    $procedures = PendirianCV::with('work_order_assignment')->where('work_order_assignment_id', $work_order_assignment_id)->get();
    ...
    return view('content.pendirian_cv.detail', compact(
      'title',
      'procedures',
  ...
  public function form($work_order_assignment_id)
  {
    ...
    // dd($wo_attachment);
    return view('content.pendirian_cv.form', compact(
      'title',
      'procedures',
      'work_order_assignment_id',
      'wo_attachment',
