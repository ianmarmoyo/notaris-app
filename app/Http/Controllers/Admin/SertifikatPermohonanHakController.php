...
class SertifikatPermohonanHakController extends Controller
{
  const PATH_IMAGE = "sertifikat_permohonan_hak/image/";
  ...
  function __construct()
  {
    ...
    view()->composer('content.sertifikat_permohonan_hak.*', function ($view) {
      $title = "Penugasan Sertifikat Permohonan Hak";
      $view->with('page_title', 'Sertifikat Permohonan Hak');
  ...
  public function store(Request $request)
  {
    ...
    $update = SertifikatPermohonanHak::find($balik_nama_waris_id);
    $update->update([
  ...
  {
    $procedures = SertifikatPermohonanHak::with('work_order_assignment')->where('work_order_assignment_id', $work_order_assignment_id)->get();
    ...
    // dd($wo_attachment);
    return view('content.sertifikat_permohonan_hak.form', compact(
      'procedures',
  ...
  public function detail($work_order_assignment_id)
  {
    ...
    return view('content.sertifikat_permohonan_hak.detail', compact(
      'procedures',
      'work_order_assignment_id',
      'wo_attachment',
