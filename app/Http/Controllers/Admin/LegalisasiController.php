...
{
  const PATH_IMAGE = "legalisasi/image/";
  function __construct()
  {
    ...
    view()->composer('content.legalisasi.*', function ($view) {
      $view->with('page_title', ucwords('Legalisasi'));
    });
  }
  ...
  public function store(Request $request)
  {
    ...
    $update = Legalisasi::find($balik_nama_waris_id);
    $update->update([
  ...
  public function form($work_order_assignment_id)
  {
    ...
    $procedures = Legalisasi::with('work_order_assignment')->where('work_order_assignment_id', $work_order_assignment_id)->get();
    ...
    return view('content.legalisasi.form', compact(
      'title',
      'procedures',
  ...
  public function detail($work_order_assignment_id)
  {
    ...
    return view('content.legalisasi.detail', compact(
      'title',
      'procedures',
      'work_order_assignment_id',
      'wo_attachment',
