...
class PendirianYayasanController extends Controller
{
  const PATH_IMAGE = "pendirian_yayasan/image/";
  function __construct()
  {
    ...
    view()->composer('content.pendirian_yayasan.*', function ($view) {
      $view->with('page_title', ucwords('Pendirian Yayasan'));
    });
  }
  ...
  public function store(Request $request)
  {
    ...
    $update = PendirianYayasan::find($balik_nama_waris_id);
    $update->update([
  ...
  public function form($work_order_assignment_id)
  {
    ...
    $procedures = PendirianYayasan::with('work_order_assignment')->where('work_order_assignment_id', $work_order_assignment_id)->get();
    ...
    // dd($wo_attachment);
    return view('content.pendirian_yayasan.form', compact(
      'title',
      'procedures',
  ...
  public function detail($work_order_assignment_id)
  {
    ...
    return view('content.pendirian_yayasan.detail', compact(
      'title',
      'procedures',
      'work_order_assignment_id',
      'wo_attachment',
