...
class AktaPermohonanHakController extends Controller
{
  ...
  function __construct()
  {
    ...
    view()->composer('content.akta_permohonan_hak.*', function ($view) {
      $title = "Penugasan Akta Permohonan Hak";
      $view->with('page_title', 'Akta Permohonan Hak');
  ...
  public function store(Request $request)
  {
    ...
    $update = AktaPermohonanHak::find($balik_nama_waris_id);
    $update->update([
  ...
  {
    $procedures = AktaPermohonanHak::with('work_order_assignment')->where('work_order_assignment_id', $work_order_assignment_id)->get();
    ...
    // dd($wo_attachment);
    return view('content.akta_permohonan_hak.form', compact(
      'procedures',
  ...
  public function detail($work_order_assignment_id)
  {
    ...
    return view('content.akta_permohonan_hak.detail', compact(
      'procedures',
      'work_order_assignment_id',
      'wo_attachment',
