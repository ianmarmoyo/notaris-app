...
class PerjanjianLainnyaController extends Controller
{
  const PATH_IMAGE = "perjanjianlainnya/image/";
  function __construct()
  {
    ...
    view()->composer('content.perjanjianlainnya.*', function ($view) {
      $view->with('page_title', ucwords('Perjanjian Lainnya'));
    });
  }
  ...
  public function store(Request $request)
  {
    ...
    $update = PerjanjianLainnya::find($balik_nama_waris_id);
    $update->update([
  ...
  public function form($work_order_assignment_id)
  {
    ...
    $procedures = PerjanjianLainnya::with('work_order_assignment')->where('work_order_assignment_id', $work_order_assignment_id)->get();
    ...
    // dd($wo_attachment);
    return view('content.perjanjianlainnya.form', compact(
      'title',
      'procedures',
  ...
  public function detail($work_order_assignment_id)
  {
    ...
    return view('content.perjanjianlainnya.detail', compact(
      'title',
      'procedures',
      'work_order_assignment_id',
      'wo_attachment',
