...
class BalikAPHBController extends Controller
{
  const PATH_IMAGE = "balik_aphb/image/";
  function __construct()
  {
    ...
    view()->composer('content.balik_aphb.*', function ($view) {
      $view->with('page_title', 'Balik APHB');
    });
  }
  ...
  public function form($work_order_assignment_id)
  {
    ...
    $procedures = BalikAPHB::with('work_order_assignment')->where('work_order_assignment_id', $work_order_assignment_id)->get();
    ...
    // dd($wo_attachment);
    return view('content.balik_aphb.form', compact(
      'title',
      'procedures',
  ...
  public function detail($work_order_assignment_id)
  {
    ...
    return view('content.balik_aphb.detail', compact(
      'title',
      'procedures',
      'work_order_assignment_id',
      'wo_attachment',
