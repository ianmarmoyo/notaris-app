...
class PelepasanHakController extends Controller
{
  const PATH_IMAGE = "pelepasan_hak/image/";
  ...
  function __construct()
  {
    ...
    view()->composer('content.pelepasan_hak.*', function ($view) {
      $title = "Penugasan Pelepasan Hak";
      $view->with('page_title', 'Pelepasan Hak');
  ...
  public function store(Request $request)
  {
    ...
    $update = PelepasanHak::find($balik_nama_waris_id);
    $update->update([
  ...
  {
    $procedures = PelepasanHak::with('work_order_assignment')->where('work_order_assignment_id', $work_order_assignment_id)->get();
    ...
    // dd($wo_attachment);
    return view('content.pelepasan_hak.form', compact(
      'procedures',
  ...
  public function detail($work_order_assignment_id)
  {
    ...
    return view('content.pelepasan_hak.detail', compact(
      'procedures',
      'work_order_assignment_id',
      'wo_attachment',
