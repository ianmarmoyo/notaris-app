                ...
                <div class="card-body">
                  <table class="table text-capitalize">
                    <thead>
                      <tr>
                        <td>Nama Penugas</td>
                        <td> : {{ $work_order_assignment->user_admin->name }}</td>
                      </tr>
                      <tr>
                        <td>Tanggal Penugasan</td>
                        <td> : {{ $work_order_assignment->tgl_penugasan }}</td>
                      </tr>
                      <tr>
                        <td>Keperluan</td>
                        <td> : {{ $work_order_assignment->work_order_detail->keperluan }}</td>
                      </tr>
                      <tr>
                        <td>Tanggal Pengajuan</td>
                        <td> : {{ $work_order_assignment->work_order_detail->work_order->tgl_pengajuan }}</td>
                      </tr>
                      <tr>
                        <td>Nama Klien</td>
                        <td> : {{ $work_order_assignment->work_order_detail->work_order->nama }}</td>
                      </tr>
                      <tr>
                        <td>No Telpon Klien</td>
                        <td> : {{ $work_order_assignment->work_order_detail->work_order->no_telp }}</td>
                      </tr>
                    </thead>
                  </table>
                </div>
                ...
                <div class="accordion-item active mb-0">
                    <div class="accordion-header" id="headingOne">
                        <button type="button" class="accordion-button bg-lighter rounded-0" data-bs-toggle="collapse"
                            ...
                            <span class="d-flex flex-column">
                                <span class="h5 mb-1">Pendirian PT</span>
