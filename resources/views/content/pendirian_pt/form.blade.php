            ...
            @foreach ($procedures as $key => $procedure)
                <div class="card accordion-item @if ($key == 0) active @endif">
                    <h2 class="accordion-header" id="headingOne">
                        <button type="button" class="accordion-button text-capitalize" data-bs-toggle="collapse"
                        ...
                        <div class="accordion-body">
                            <form action="">
                                ...
                                <div class="row">
                                    ...
                                    @if ($procedure->proses === 'penyerahan' || $procedure->proses === 'TTD akta')
...
@section('page-script')
    ...
    <script>
        ...
        function saveProcedure(e) {
            ...
            $.ajax({
                url: "{{ route('admin-pendirianpt-store') }}",
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
