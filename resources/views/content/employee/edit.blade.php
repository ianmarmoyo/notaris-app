            ...
            <div class="card mb-3">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade active show" id="form-tabs-personal" role="tabpanel">
                        ...
                        <form method="POST" id="form" action="{{ route('admin-employee-update', $employee->id) }}">
                            @csrf
                            @method('put')
                            <div class="row mb-3 g-3">
                                <div class="col-md-6">
                                    <label class="form-label" for="nama">Nama</label>
                                    <input type="text" id="nama" name="nama" value="{{ $employee->nama }}" class="form-control test"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="date_birth" name="date_birth" class="form-control dob-picker"
                                        placeholder="YYYY-MM-DD" value="{{ $employee->tgl_lahir }}" />
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="gender" id="" class="select2 form-select">
                                        ...
                                        @foreach (config('enums.gender') as $key => $value)
                                            <option value="{{ $key }}" @if($key == $employee->jk)
                                                selected
                                            @endif>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="religion" id="" class="select2 form-select text-capitalize">
                                        ...
                                        @foreach (config('enums.regligions') as $key => $value)
                                            <option value="{{ $key }}" @if($key == $employee->agama)
                                                selected
                                            @endif>{{ $value }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="phone" name="phone" class="form-control"
                                        placeholder="658 799 8941" aria-label="658 799 8941" value="{{ $employee->no_telp }}"/>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label" for="address">Alamat Lengkap</b></label>
                                    <textarea name="address" id="" cols="30" rows="3" class="form-control"
                                        placeholder="Perumahan, Blok A01">{{ $employee->alamat }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                  <label class="form-label" for="photo">Lampiran</label>
                                  <br>
                                  <img src="{{ $employee->view_foto }}" alt="" class="rounded">
                                </div>
                            </div>
                        </form>
                    </div>
