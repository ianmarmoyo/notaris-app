                                ...
                                <div class="row">
                                    ...
                                    @if ($procedure->proses == 'Rekomendasi')
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select id="rekomendasi" name="rekomendasi" class="select2 form-select"
                                                placeholder="Rekomendasi..." data-allow-clear="true">
                                                <option value="">

                                                </option>
                                                <option value="pemasaran" @if ($procedure->rekomendasi == strtolower('pemasaran')) selected @endif>
                                                    Pemasaran
                                                </option>
                                                <option value="Konsumen" @if ($procedure->rekomendasi == strtolower('Konsumen')) selected @endif>
                                                    Konsumen</option>
                                                <option value="Jasa" @if ($procedure->rekomendasi == strtolower('Jasa')) selected @endif>
                                                    Jasa
                                                </option>
                                                <option value="Produsen" @if ($procedure->rekomendasi == strtolower('Produsen')) selected @endif>
                                                    Produsen
                                                </option>
                                                <option value="KSP" @if ($procedure->rekomendasi == strtolower('KSP')) selected @endif>
                                                    KSP
                                                </option>
                                            </select>
                                        </div>
...
@section('page-script')
    ...
    <script>
        ...
        function saveProcedure(e) {
            ...
            $.ajax({
                url: "{{ route('admin-pembubarankoperasi-store') }}",
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
