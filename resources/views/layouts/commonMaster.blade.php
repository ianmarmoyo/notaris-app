...
<html lang="{{ session()->get('locale') ?? app()->getLocale() }}"
    class="{{ $configData['style'] }}-style {{ $navbarType ?? '' }} {{ $menuFixed ?? '' }} {{ $menuCollapsed ?? '' }} {{ $footerFixed ?? '' }} {{ $customizerHidden ?? '' }}"
...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{ asset('storage/' . config('configs.favicon_icon')) }}" />
